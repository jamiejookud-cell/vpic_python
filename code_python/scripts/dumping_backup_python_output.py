...
def save(time_start: datetime, filename: str=""):
    ...
    if filename == "":
        output_file = os.path.join(OUTPUT_FILE_PATH, f"run_{time_output}_UTC{offset}" + ".txt")
    else:
        output_file = os.path.join(OUTPUT_FILE_PATH, filename + ".txt")
