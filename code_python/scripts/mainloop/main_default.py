    ...
    for folder_index, folder_name in enumerate(folders):
        ...
        if IS_CALCULATING_LORENTZ_TRANSFORMATION:
            ...
            if box_index[0] < 0 or box_index[1] > nx:
                ...
                backup.dump_process(
                    f"Not calculated Lorentz transformation at T.{current_timestep}: box frame outsides simulation frame.")
                continue # Continue to next iteration for prevent calculation errors.
